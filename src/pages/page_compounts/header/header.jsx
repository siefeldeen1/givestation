    ...
    return (
        <div className='header_bg'>
            <header>
                ...
                <div>
                    <Button text={"Submit a Grant "} styles={{ fontSize: "16px", fontWeight: "bold" }} />
                </div>
            </header>
            ...
            <section className='header_section'>
                ...
                <div className='header_btns'>
                    <Button text={`Read More`} styles={{ background: "#343F58", color: "white", padding: "16px 35px", fontSize: "14px", height: "100%" }} />
                    <Button text={`Explore Grants`} icon={<CiShare1 size={22} style={{ marginBottom: "2px" }} />} styles={{ background: "linear-gradient(0.25turn, rgba(52, 149, 255, 1)20%, rgba(78, 206, 201, 1)100%)", color: "white", padding: "13px 36px", fontSize: "15px", height: "100%" }} />
                </div>
            </section>
